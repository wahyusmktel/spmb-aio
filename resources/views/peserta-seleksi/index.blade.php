                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full">
                                <thead>
                                    <tr>
                                        <th
                                            class="py-2 px-2 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase">
                                            No. Pendaftaran</th>
                                        <th
                                            class="py-2 px-2 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase">
                                            Nama Pendaftar</th>
                                        ...
                                        <th
                                            class="py-2 px-2 text-right text-xs font-medium text-gray-500 dark:text-gray-300 uppercase">
                                            Aksi</th>
                                    </tr>
                                </thead>
                                <tbody>
                                ...
                                @forelse ($pesertaTerdaftar as $peserta)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="font-mono px-2 py-1 bg-gray-200 dark:bg-gray-700 rounded">
                                                {{ $peserta->akunCbt->username ?? 'N/A' }}
                                            </span>
                                        </td>
                                        <td
                                            class="px-6 py-4 whitespace-noww
                                        rap text-right text-sm font-medium">
