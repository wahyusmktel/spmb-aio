...
<head>
    <meta charset="utf-8">
    <title>Rekapitulasi Laporan Peserta</title>
    <style>
        @page {
            margin: 40px;
        }
...
<body>
    <div class="kop-surat">
        <h1>REKAPITULASI LAPORAN PESERTA SELEKSI</h1>
    ...
    <p class="info-filter">
        <strong>Filter Tanggal Kegiatan:</strong>
        @if ($tanggal_mulai && $tanggal_akhir)
            {{ \Carbon\Carbon::parse($tanggal_mulai)->isoFormat('D MMM YYYY') }} s/d
