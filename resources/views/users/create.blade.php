<x-app-layout>
    ...
    <!-- Kita pakai Alpine.js untuk show/hide mapping guru -->
            ...
            <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <form action="{{ route('users.store') }}" method="POST" class="p-6 space-y-6">
                        ...
                        <!-- Mapping Guru (Hanya Tampil Jika Role 'Guru' Dipilih) -->
                        <div x-show="selectedRoles.includes('Guru')" style="display: none;">
                            ...
                            <!-- 'dark:text-gray-400' dihapus -->
                            <p class="text-sm text-gray-600">Pilih data guru untuk di-link ke akun user ini. (Hanya guru
                                yang belum ter-link yang tampil).</p>
